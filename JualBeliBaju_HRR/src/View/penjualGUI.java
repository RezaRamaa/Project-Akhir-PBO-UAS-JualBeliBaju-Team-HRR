    ...
    public penjualGUI() {
        ...
        verif.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                AllObjctrl.penjual.updateIsVerified(index,AllObjctrl.pembeli.showDaftarPembeli(index).getIndexBaju(),AllObjctrl.pembeli.showDaftarPembeli(index).getPembeli());
                tabelpembeli.setModel(pembeli.daftarpembeli());
            }
