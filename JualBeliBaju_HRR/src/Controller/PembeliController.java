...
public class PembeliController implements ControllerInterface {
    ...
    public void daftarbaju(int indexbaju,PembeliEntity pembeliEntity,boolean isVerified) {
        AllObjectModel.daftar.insertDataDaftar(new daftarpembeli(pembeliEntity,isVerified, indexbaju));
}
    ...
    public void update(String Baju, int UpdateBaju) {
        AllObjectModel.daftar.update(Baju, UpdateBaju);
    }
    ...
    public DefaultTableModel daftarpembeli() {
        ...
        Object[] kolom = {"nama","password","alamat","baju","verifikasi"};
        ...
        for(int i=0; i<size;i++){
            ...
            data[3] = AllObjectModel.daftar.alldatapembeli().get(i).getIndexBaju();
            data[4] = verif;
